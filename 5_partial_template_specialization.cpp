...
/*
#A Sorting algorithm for pointers for example: Bubble Sort
#B Read numbers from user input until a non-integer value is entered
#C Sorting the numbers
#D Printing the sorted numbers
#E Sorting the pointers
#F Printing the sorted pointers
*/